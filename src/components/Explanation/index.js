    ...
    return (
        <Container className="warning">
            <Row className="banner-explanation">
                ...
                <p className="text-explanation">But perhaps, the marketing of the product in the medium of a website is in itself a "game". </p>
                ...
                <p className="text-explanation">If you wish to do so, you may click the button below to go back to the website and "replay the game".</p>
                <Button variant="success" className="btn-replay" href="/" target="_blank">Replay</Button>
                <p className="text-explanation">Here are my thoughts on the matter.</p>
