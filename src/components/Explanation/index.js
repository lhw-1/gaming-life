    ...
    return (
        <Container className="warning">
            <Row className="banner-explanation">
                ...
                <p className="text-explanation">But perhaps we can also frame the marketing of the product, in the medium of a website, as a "game". When given this perspective, I’m sure you can think of some ways in which the website could be construed as a game.</p>
                ...
                <p className="text-explanation">Here are my thoughts on the project.</p>
